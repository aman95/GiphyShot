...
public class OverlayService extends Service implements View.OnTouchListener, View.OnClickListener {
    ...
    public void onCreate() {
        ...
        overlayedButton.setText("Stop Rec");
        overlayedButton.setOnTouchListener(this);
        overlayedButton.setAlpha(0.5f);
        overlayedButton.setBackgroundColor(Color.CYAN);
    ...
    public void onClick(View v) {
        if(OverlayActivity.isRecording) {
            OverlayActivity.mHandler.post(new Runnable() {
                @Override
                public void run() {
                    if (OverlayActivity.sMediaProjection != null) {
                        OverlayActivity.sMediaProjection.stop();
                    }
                }
            });
